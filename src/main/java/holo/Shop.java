...
public class Shop extends JFrame {
    ...
    public Shop(FriendStats stats, Bed bed, Radio radio, Wardrobe wardrobe) {
        ...
        if(!stats.getSuperRod() && stats.getGoodRod()){
            add(buySuperRod);
        } else if (stats.getSuperRod()){
